...
const steps = [
  ...
  { num: "02", title: "Define your workflow", desc: "Write your workflow steps as normal functions. Torqvio handles the durability layer." },
  { num: "03", title: "Deploy in one command", desc: "Push to Torqvio Cloud. Your workflow is live, observable, and durable immediately." },
  ...
  },
  {
    ...
    code: (
      <>
        ...
        <div>&nbsp;</div>
        <div><span className="text-green">✓</span> <span className="text-txt2">Bundling workflow...</span></div>
        <div><span className="text-green">✓</span> <span className="text-txt2">Validating steps...</span></div>
        <div><span className="text-green">✓</span> <span className="text-txt2">Uploading to Torqvio Cloud...</span></div>
        <div><span className="text-green">✓</span> <span className="text-txt2">charge-and-notify deployed</span></div>
        <div>&nbsp;</div>
  ...
  },
  {
    ...
    code: (
      <>
        ...
        <div>&nbsp;&nbsp;<span className="text-green">✓</span> <span className="text-txt2">validate-order &nbsp;&nbsp;&nbsp;12ms</span></div>
        <div>&nbsp;&nbsp;<span className="text-green">✓</span> <span className="text-txt2">charge-card &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;341ms</span></div>
        <div>&nbsp;&nbsp;<span className="text-green">✓</span> <span className="text-txt2">send-receipt &nbsp;&nbsp;&nbsp;&nbsp;88ms</span></div>
        <div>&nbsp;&nbsp;<span className="text-green">✓</span> <span className="text-txt2">completed &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;441ms total</span></div>
        <div>&nbsp;</div>
        ...
        <div>&nbsp;&nbsp;<span className="text-green">✓</span> <span className="text-txt2">validate-order &nbsp;&nbsp;&nbsp;11ms</span></div>
        <div>&nbsp;&nbsp;<span className="text-green">✓</span> <span className="text-txt2">charge-card &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;290ms</span></div>
        <div>&nbsp;&nbsp;✗ <span className="text-red">send-receipt &nbsp;&nbsp;&nbsp;&nbsp;SMTP timeout (retry 1/3)</span></div>
        <div>&nbsp;&nbsp;<span className="text-green">✓</span> <span className="text-txt2">send-receipt &nbsp;&nbsp;&nbsp;&nbsp;102ms <span className="text-txt3">← resumed here</span></span></div>
        <div>&nbsp;&nbsp;<span className="text-green">✓</span> <span className="text-txt2">completed &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;403ms total</span></div>
      </>
    ),
  },
];
