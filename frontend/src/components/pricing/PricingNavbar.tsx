...
export default function PricingNavbar({ onLogin, onSignup }: PricingNavbarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-8 text-sm text-gray-400">
        <button onClick={() => router.push('/features')} className="hover:text-white transition-colors">
          Features
        </button>
