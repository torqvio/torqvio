...
export function LogoFull({ className, iconSize = 32 }: LogoFullProps) {
  return (
    <div className={cn('flex items-center gap-3', className)}>
      <LogoMark size={iconSize} className="text-primary flex-shrink-0" />
      <div className="min-w-0">
        <p className="text-sm font-bold text-text-primary leading-none tracking-tight">Torqvio</p>
        <p className="text-[10px] text-text-secondary leading-none mt-1">Durable Execution Engine</p>
      </div>
    </div>
  )
}
